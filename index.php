...
<body>
 ...
 <form action="" class="search-form">
    ...
    <section id="banner">
        <img id="videobcg"  src="img/prush.jpg"  >
          
         
          
         <h4> ساعد البيئة بإعادة الاستخدام</h4>
        <h2>نهدف لأن يكون</h2>
        <h1>الفن في متناول الجميع </h1>
        <p>تسوق بسعر ارخص</p>
    ...
    <section id="signup" class="section-p1 section-m1">
        ...
        <button class="normal"  onclick="document.getElementById('id01').style.display='block'"> تسجيل </button>

     <div class="sign">

         <h4> سجل لعرض منتجاتك</h4>
         <p>لتتمكن من عرض منتجاتك سجل كمستخدم جديد في موقعنا</p> 
